                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-5 sm:mb-8 text-center">
                            <img src="/images/logo/jata-negeri-perak.png" alt="Logo" class="mx-auto h-24 w-auto mb-4" />
                            <h1 class="text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                                Log Masuk Sistem
                            </h1>
                            <p class="text-sm font-bold text-gray-800 dark:text-white/90">
                                Sistem Integrasi Kebajikan Mualaf (SiKEM)
                            </p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Pejabat Agama Daerah Manjung
                            </p>
                        </div>
                        <div>
                            @if ($errors->any())
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            E-mel / Username / No. K/P<span class="text-error-500">*</span>
                                        </label>
                                        <input type="text" id="login_id" name="login_id" value="{{ old('login_id') }}" placeholder="Masukkan e-mel, username, atau No. K/P"
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Hak Cipta Terpelihara &copy; 2026 Unit Dakwah Pejabat Agama Daerah Manjung.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <div class="mb-4 block">
                            <img src="/images/logo/jata-negeri-perak.png" alt="Logo" class="h-24 w-auto" />
                        </div>
                        <p class="text-center text-gray-200 dark:text-white/60">
                            Sistem Integrasi Kebajikan Mualaf (SiKEM)
                        </p>
                    </div>
                </div>
